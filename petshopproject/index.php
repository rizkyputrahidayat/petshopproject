...
<div id="carouselExampleIndicators" class="carousel slide mt-5" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?= url ?>assets/images/bg_a.jpg" class="d-block w-100" alt="..." style="height:600px !important;">
        </div>
        <div class=" carousel-item">
            <img src="<?= url ?>assets/images/bg_d.jpg" class="d-block w-100" alt="..." style="height:600px !important;">
        </div>
    </div>
</div>
...
<!-- Produk Baru -->
<div class=" mt-5">
    <h5 class="text-uppercase">Premium Product</h5>
        ...
        <?php foreach ($produk as $value) : ?>
            <div class="col-md-2 card-produk shadow-sm m-1  bg-white">
                ...
                <div class="d-flex justify-content-around p-2 w-75 border-top m-auto">
                    <a href="<?= url ?>detail.php/?id=<?= $value->id_produk ?>" class="btn btn-sm btn-info mr-1 ">Detail</a>
